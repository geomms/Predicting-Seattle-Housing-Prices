...
## Project Intro/Objective
  ...
  With the data given to us, we also created a price prediction model. We trained and tested our model to predict prices given the features of the dataset.
